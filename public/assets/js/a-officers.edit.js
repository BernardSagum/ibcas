$(document).ready(function(){
  ...
  function loadViewData(id){
      ...
      .then(function(response) {
          ...
          document.getElementById('user_id').value = response.data.recdata[0].user_id;
          document.getElementById('user_label').value = response.data.recdata[0].accountable_person;
          document.getElementById('type').value = response.data.recdata[0].type;
          document.getElementById('o_username').value = response.data.recdata[0].username;
