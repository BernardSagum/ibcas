...
<?= $this->section('title') ?>
iBCAS | Edit accountable officer information
<?= $this->endSection() ?>
            ...
            <div class="row">
                ...
                <div class="col-10">
                    <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                        <h4 class="mb-sm-0 font-size-18">Edit accountable officer </h4>
                    ...
                    <div class="card">
                        ...
                        <div class="row">
                            <div class="col-12" style="text-align: right;">
                                ...
                                <input id="off_id" name="off_id" value="<?php echo $p_id?>" type="hidden">
                            </div>
                        </div>
