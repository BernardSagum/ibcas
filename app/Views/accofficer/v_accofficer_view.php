...
<?= $this->section('title') ?>
iBCAS | Accountable Officers View
<?= $this->endSection() ?>
        ...
        <div class="container-fluid">
            ...
            <div class="row">
                ...
                <div class="col-8">
                    <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                        <h4 class="mb-sm-0 font-size-18">View Accountable Officer Details</h4>
                        <div class="page-title-right">
                                        <ol class="breadcrumb m-0">
                                            <li class="breadcrumb-item">Accountable Officer</li>
            ...
            <div class="col-8">
                    ...
                    <div class="card placeholder-glow">
                        ...
                        <input type="hidden" id="off_id" name="off_id" value="<?php echo $p_id ?>">
                        <div class="row">
                            <div class="col-12">
                        ...
                        <div class="row">
                            <div class="col-6">
                                <label>Username : </label><br>
                                    <p id="username" class="pbld"><span  class="placeholder col-12"></span> </p>
                            </div>
                            <div class="col-6">
                                <label>Type : </label><br>
                                    <p id="type" class="pbld"><span  class="placeholder col-12"></span> </p>
                            </div>
