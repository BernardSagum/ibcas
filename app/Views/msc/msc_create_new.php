    ...
    <div class="position-fixed p-3" style="z-index: 1005; left:50%; transform:translate(-50%,-80%); color:aliceblue;">
        ...
        <div class="container-fluid">
            ...
            <div class="row">
                ...
                <div class="col-10">
                    <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                        <h4 class="mb-sm-0 font-size-18">Add New Miscellaneous Fee</h4>
            ...
            <div class="col-xl-10">
                    ...
                    <div class="card">
                        <div class="card-body">
                        <form id="ftr_new_mscFee" class="needs-validation" novalidate>
                        <div class="row">
                            <div class="col-6">
                            ...
                            <div class="col-6" style="text-align: right;">
                                ...
                                <input type="hidden" id="msc_" name="msc_id">
                            </div>
                        </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-7">
                                <label for="taxyreffect">Miscellaneous Fee Name <span style="color:red;">*</span></label>
                                <input class="form-control" id="msc_name" name="msc_name" type="text" required>
                            </div>
                            <div class="col-5">
                                <label>Fee Amount<span style="color:red;">*</span></label>
                                <input style="text-align: right;" class="form-control curr" id="msc_amount" name="msc_amount" required>
                            </div>
                        </div>
                        <br>
                        <div class="row">
                            <div class="col-12">
                                <button class="btn btn-success" id="frm_submit" data-placement="top" data-toggle="tooltip" title="Save Fee" style="width: 100%;">SAVE FEE</button>
