    ...
    <div class="position-fixed p-3" style="z-index: 1005; left:50%; transform:translate(-50%,-80%); color:aliceblue;">
        ...
        <div class="container-fluid">
            ...
            <div class="row">
                ...
                <div class="col-10">
                    <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                        <h4 class="mb-sm-0 font-size-18">Add New Claimstub Schedule</h4>
            ...
            <div class="col-xl-10">
                    ...
                    <div class="card">
                        <div class="card-body">
                        <form id="ftr_new_claimstub" class="needs-validation" novalidate>
                        <div class="row">
                            <div class="col-6">
                        ...
                        <div class="row">
                            ...
                            <div class="col-6">
                                <label for="taxyreffect">Tax Year Effectivity <span style="color:red;">*</span></label>
                                <input class="form-control yrclass" id="taxyreffect" name="taxyreffect" type="text" required min="1900" max="2099">
                            </div>
                        </div>
                        <br>
                        <div class="row">
                        ...
                        <div class="row">
                            ...
                            <div class="col-6">
                                ...
                                <input class="form-control" id="second_quarter_peak_date" name="second_quarter_peak_days" required>
                            </div>
                        </div>
                        <br>
                        <div class="row">
                        ...
                        <div class="row">
                            <div class="col-12">
                                <button type="submit" class="btn btn-success" id="frm_submit" data-placement="top" data-toggle="tooltip" title="Save schedule" style="width: 100%;">Save schedule</button>
