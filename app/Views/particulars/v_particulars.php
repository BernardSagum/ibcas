        ...
        <div class="container-fluid">
            ...
            <div class="row">
                ...
                <div class="col-12">
                    <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                        <h4 class="mb-sm-0 font-size-18">Particulars Masterlist</h4>
            ...
            <div class="row">
                <div class="col-xl-12">
                    ...
                    <div class="card">
                        <div class="card-body">
                            <form id="ftr-particulars" class="needs-validation" novalidate>
                                <div class="row">
                ...
                <div class="col-xl-12">
                    <div class="card">
                        <div class="card-body">
                            <div class="row">
                                <div class="col-12">
                                    <a href="<?php echo base_url('/ibcas/particulars/create')?>" data-placement="top" data-toggle="tooltip" title="Add new accountable form" target="_blank"
                                        class="btn btn-secondary">Add New Particular</a>
                                </div>
                            </div>
                            <br>
                            <!-- <h4 class="card-title mb-3">Inspection Report</h4> -->
                            <table id="particulars-table" class="table table-bordered table-striped" width="100%"
                                style="text-align: center; vertical-align: middle;">
                                <thead style="font-weight: bold; text-align: center; vertical-align: middle;">
                                    <tr>
                                    <td style="width: 35% !important;">Particular Name</td>
                                        <!-- <td style="width: 20% !important;">Alias</td> -->
                                       
                                        <td style="width: 30% !important;">Particular Type</td>
