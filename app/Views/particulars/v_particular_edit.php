            ...
            <div class="row">
                ...
                <div class="col-10">
                    <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                        <h4 class="mb-sm-0 font-size-18">Update Particular</h4>
            ...
            <div class="col-xl-10">
                    ...
                    <div class="card">
                        ...
                        <form id="frm-addParticular" class="needs-validation" novalidate>
                            <input type="hidden" id="PartId" name="PartId" value="<?php echo $p_id; ?>">
                            <div class="row">
                        ...
                        <div class="row">
                            <div class="col-12">
                                <button class="btn btn-success" data-toggle="tooltip" id="frm_submit" title="Update particular" style="width: 100%;">UPDATE PARTICULAR</button>
