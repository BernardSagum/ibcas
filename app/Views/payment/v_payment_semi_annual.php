            ...
            <div class="row">
                ...
                <div class="col-10">
                    <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                        <h4 class="mb-sm-0 font-size-18">Transaction Details (Semi-Annual)</h4>
                        <div class="page-title-right">
                            <ol class="breadcrumb m-0">
                                <li class="breadcrumb-item">Payment</li>
                                <li class="breadcrumb-item active">Semi-annual</li>
                            </ol>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-10">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="col-12">
                                <label>Next O.R. is 4167899 as of July 7, 2023</label>
                            </div>
                            </div>
