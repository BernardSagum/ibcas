        ...
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-xl-12">
                    ...
                    <div class="card">
                        <div class="card-body">
                            <form id="ftr-cAccounts" class="needs-validation" novalidate>
                                <div class="row">
                ...
                <div class="col-xl-12">
                    <div class="card">
                        <div class="card-body">
                            <div class="row">
                                <div class="col-12">
                                    <a href="<?php echo base_url('/ibcas/cAccounts/create')?>" data-placement="top" data-toggle="tooltip" title="Add new accountable form" target="_blank"
