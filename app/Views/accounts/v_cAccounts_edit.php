            ...
            <div class="row">
                ...
                <div class="col-10">
                    <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                        <h4 class="mb-sm-0 font-size-18">Update Account</h4>
            ...
            <div class="col-xl-10">
                    ...
                    <div class="card">
                        ...
                        <form id="frm-addAccount" class="needs-validation" novalidate>
                            <input type="hidden" id="accID" name="accID" value="<?php echo $p_id; ?>">
                            <div class="row">
                        ...
                        <div class="row">
                            ...
                            <label>Account nature <span style="color:red;"></span></label>
                                ...
                                <div class="col-9">
                                <label> <input type="radio" class="form-check-input" id="account_nature2" name="account_nature" value="2">  Credit </label>
                                </div>
                                </div>
                        ...
                        <div class="row">
                            <div class="col-12">
                                <button class="btn btn-success" data-toggle="tooltip" id="frm_submit" title="Update Account" style="width: 100%;">Update Account</button>
