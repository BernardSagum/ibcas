                        ...
                        <div class="row">
                            ...
                            <div class="col-6">
                                <label>Account title : </label><br>
                                    <p id="title" class="pbld"><span class="placeholder col-12"></span></p>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-6">
                                <label>Acronym : </label><br>
                                    <p id="acronym" class="pbld"><span class="placeholder col-12"></span></p>
                            </div>
                            <div class="col-6">
                                <label>Account type : </label><br>
                                    <p id="account_type" class="pbld"><span class="placeholder col-12"></span></p>
                            </div>
                            <div class="col-6">
                                <label>Account nature : </label><br>
                                    <p id="account_nature" class="pbld"><span class="placeholder col-12"></span></p>
                            </div>
