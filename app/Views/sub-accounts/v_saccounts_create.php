            ...
            <div class="row">
                ...
                <div class="col-10">
                    <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                        <h4 class="mb-sm-0 font-size-18">Add New Sub-Account</h4>
                                ...
                                <div class="row">
                                    <div class="col-3">
                                        <div class="form-check form-check-primary mb-3">
                                            <input class="form-check-input optcbx" data-val="NoParticular"
                                                type="checkbox" name="options[]" id="noParticular" value="NoParticular"
                                                required>
                                    ...
                                    <div class="col-3">
                                        <div class="form-check form-check-success mb-3">
                                            <input class="form-check-input optcbx" data-val="ForCashTicket"
                                                name="options[]" type="checkbox" id="forCashTicket"
                                                value="ForCashTicket" required>
                                    ...
                                    <div class="col-3">
                                        <div class="form-check form-check-info mb-3">
                                            <input class="form-check-input optcbx" data-val="ForCTC" name="options[]"
                                                type="checkbox" id="forCTC" value="ForCTC" required>
                                    ...
                                    <div class="col-3">
                                        <div class="form-check form-check-danger">
                                            <input class="form-check-input optcbx" data-val="forTaxCredit"
                                                name="options[]" type="checkbox" id="forTaxCredit" value="ForTaxCredit"
                                                required>
