    ...
    <div class="position-fixed p-3" style="z-index: 1005; left:50%; transform:translate(-50%,-80%); color:aliceblue;">
        ...
        <div class="container-fluid">
            ...
            <div class="col-1"></div>
                <div class="col-10">
                    <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                        <h4 class="mb-sm-0 font-size-18">Assign Receipt</h4>
            ...
            <div class="col-xl-10">
                    ...
                    <div class="card">
                        <div class="card-body">
                        <form id="ftr_assign_form" class="needs-validation" novalidate>
                        <div class="row">
                        ...
                        <div class="row">
                            ...
                            <div class="col-12">
                                ...
                                <input class="form-control" type="date" required value="<?php echo date('Y-m-d'); ?>" min="<?php echo date('1900-01-01'); ?>" max="<?php echo date('Y-m-d'); ?>" id="date_issued" name="date_issued">
                            </div>
                        ...
                        <div class="row">
                            <div class="col-12">
                                <button class="btn btn-success" id="frm_submit" style="width: 100%;">Assign</button>
