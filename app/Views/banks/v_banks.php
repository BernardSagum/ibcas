                            ...
                            <div class="row">
                                <div class="col-12">
                                    <a href="<?php echo base_url('/ibcas/banks/create')?>" data-placement="top" data-toggle="tooltip" title="Add new collector" target="_blank"
                                        class="btn btn-secondary">Add New Bank</a>
                                </div>
                            </div>
                            <br>
                            <!-- <h4 class="card-title mb-3">Inspection Report</h4> -->
                            <table id="tbl-banks" class="table table-bordered table-striped" width="100%"
                                style="text-align: center; vertical-align: middle;">
                                <thead style="font-weight: bold; text-align: center; vertical-align: middle;">
                                    <tr>
                                        <td style="min-width: 20% !important;">Bank Name</td>
                                        <td style="min-width: 15% !important;">Alias</td>
                                        ...
                                        <td style="min-width: 15% !important;">Action</td>
