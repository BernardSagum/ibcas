                        ...
                        <div class="row">
                            <div class="col-12">
                                <label>Bank Name</label><br>
                                    <p id="bankName" class="pbld"><span class="placeholder col-12"></span></p>
                                    <!-- <label id="application_type_id"></label> -->
                            </div>
                            <!-- <div class="col-6">
                                <label>Alias : </label><br>
                                    <p id="alias" class="pbld"><span  class="placeholder col-12"></span> </p>
                            </div> -->
                        </div>
                        <br>
                        <div class="row">
                            ...
                            <div class="col-6">
                                <label>Branch Name : </label><br>
                                    <p id="branch" class="pbld"><span class="placeholder col-12"></span></p>
                            </div>
                            <div class="col-6">
                        ...
                        <div class="row">
                            <div class="col-6">
                                <label>Contact Person : </label><br>
                                    <p id="contact_person" class="pbld"><span class="placeholder col-12"></span></p>
                            </div>
                            <div class="col-6">
