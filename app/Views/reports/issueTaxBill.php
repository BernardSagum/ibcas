            ...
            <div class="row">
                ...
                <div class="col-12">
                    <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                        <h4 class="mb-sm-0 font-size-18">Report - Tax Bill</h4>
                        <div class="page-title-right">
                            <ol class="breadcrumb m-0">
                                <li class="breadcrumb-item">Issuance</li>
                        ...
                        <div class="card-body">
                            ...
                            <table id="tbl_BusinessMasterlist" class="table table-bordered table-striped" width="100%"
                                ...
                                <thead style="font-weight: bold; text-align: center; vertical-align: middle;">
                                    <tr>
                                        <td style="max-width: 15% !important; min-width:15% !important">Application Types</td>
                                        <td style="max-width: 20% !important; min-width:20% !important">Business Control Number</td>
                                        <td style="max-width: 30% !important; min-width:30% !important">Business Name</td>
                                        <td style="max-width: 20% !important; min-width:20% !important">Tax Payer</td>
                                        <!-- <td style="max-width: 15% !important;">Tax Credit Amount</td> -->
                                        <td style="max-width: 15% !important; min-width:15% !important"></td>
