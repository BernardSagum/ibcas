        ...
        <div class="container-fluid">
            ...
            <div class="row">
                ...
                <div class="col-10">
                    <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                        <h4 class="mb-sm-0 font-size-18">Official Receipt SUMMARY</h4>
            ...
            <div class="col-xl-1"></div>
                <div class="col-xl-10">
                    ...
                    <div class="card">
                        <div class="card-body">
                            <form id="ftr-orSummary" class="needs-validation" novalidate>
                                <div class="row">
                                <div class="col-6" >
                                ...
                                <input type="date" class="form-control" name="OrDate" id="OrDate" value="<?php echo date('Y-m-d') ?>" required>
                                </div>
                                </div>
                                <br>
                                <div class="row">
                                ...
                                <input class="form-control" type="text" id="from" name="from" required maxlength="7">
                                </div>

                                <div class="col-4">
                                    <label>To : <span style="color:red;">*</span></label>
                                    <input class="form-control" type="text" id="to" name="to" required maxlength="7">
                                </div>
                                <div class="col-4" style="padding-top: 2.5%; text-align:right;">
                                <button type="submit" id="frm_submit" data-placement="top" data-toggle="tooltip" title="Genarate Summary" class="btn btn-success">Generate Summary</button>
