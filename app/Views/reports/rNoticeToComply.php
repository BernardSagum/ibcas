        ...
        <div class="container-fluid">
            ...
            <div class="row">
                ...
                <div class="col-10">
                    <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                        <h4 class="mb-sm-0 font-size-18">Report - Notice to Comply</h4>
            ...
            <div class="col-xl-1"></div>
                <div class="col-xl-10">
                    ...
                    <div class="card">
                        <div class="card-body">
                            <form id="ftr-notice-report" class="needs-validation" novalidate>
                                <div class="row">
                                <div class="col-4">
                                <label>From : <span style="color:red;">*</span></label>
                                <input type="text" class="form-control serMask" name="serFrom" id="serFrom" required>
                                </div>

                                <div class="col-4">
                                    <label>To : <span style="color:red;">*</span></label>
                                    <input type="text" class="form-control serMask" name="serTo" id="serTo" required>
                                </div>
                                </div>
                                <div class="row">
                                <div class="col-4" style="padding-top: 2.5%;">
                                <button type="submit" id="frm_submit" data-placement="top" data-toggle="tooltip" title="Genarate Report" class="btn btn-success">Generate Notice to Comply Report</button>
