        ...
        <div class="container-fluid">
            ...
            <div class="row">
                ...
                <div class="col-10">
                    <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                        <h4 class="mb-sm-0 font-size-18">LOGBOOK - BUSINESS</h4>
            ...
            <div class="col-xl-1"></div>
                <div class="col-xl-10">
                    ...
                    <div class="card">
                        <div class="card-body">
                            <form id="ftr-OrLogbook" class="needs-validation" novalidate>
                                <div class="row">
                                <div class="col-6" >
                                    <label>Collector : <span style="color:red;">*</span></label>
                                ...
                                <div class="col-4">
                                    ...
                                    <input type="date" class="form-control DateTo mxDateToday" name="DateTo" id="DateTo" required>
                                </div>
                                </div>
                                <div class="row">
                                <div class="col-4" style="padding-top: 2.5%;">
                                <button type="submit" id="frm_submit" data-placement="top" data-toggle="tooltip" title="Genarate Logbook" class="btn btn-success">Generate Logbook</button>
