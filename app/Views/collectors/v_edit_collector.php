    ...
    <div class="position-fixed p-3" style="z-index: 1005; left:50%; transform:translate(-50%,-80%); color:aliceblue;">
        ...
        <div class="offcanvas offcanvas-end" tabindex="-1" id="offcanvasUser" aria-labelledby="offcanvasUserLabel" aria-modal="true" role="dialog">
            ...
            <div class="row">
                ...
                <div class="col-10">
                    <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                        <h4 class="mb-sm-0 font-size-18">Edit Collector</h4>
            ...
            <div class="col-xl-10">
                    ...
                    <div class="card">
                        <div class="card-body">
                        <form id="frm_edit_collector" class="needs-validation" novalidate>
                        <div class="row">
                        ...
                        <div class="row">
                            <div class="col-4">
                                ...
                                <input class="form-control" id="col_id" name="col_id" readonly value="<?php echo $p_id?>">
                            </div>
                        </div>
                        <div class="row">
                        <div class="col-12">
                            ...
                            <div class="col-6">
                                ...
                                <select class="form-control" type="text" id="position_id" name="position_id"></select>
                            </div>
                            <div class="col-12">
