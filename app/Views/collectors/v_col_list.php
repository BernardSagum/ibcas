            ...
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                        <h4 class="mb-sm-0 font-size-18">Collectors</h4>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-4">
                                        <select class="form-select" id="ftr_selby" name="ftr_selby">
                                            ...
                                            <option value="colname">Collector's name</option>
                                            <option value="officer">Accountable officer</option>
                                        </select>
                                    </div>
                                    <div class="col-sm-4">
                ...
                <div class="col-xl-12">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <table id="tblcollectors" class="table table-bordered table-striped" width="100%"
                                style="text-align: center; vertical-align: middle;">
                                <thead style="font-weight: bold; text-align: center; vertical-align: middle;">
                                    <tr>
                                        <td style="width: 15% !important;">ID Number</td>
                                        <td style="width: 25% !important;">Collector Name</td>
                                        <td style="width: 25% !important;">Accountable Officer</td>
                                        <td style="width: 15% !important;">Contact Number</td>
