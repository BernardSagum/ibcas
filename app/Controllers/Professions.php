...
class Professions extends BaseController
{
    ...
    public function index(){   
        ...
        if ($session->get('isLoggedIn')) {
            $AuditTrail->save_logs('Visit Professions Masterlist ',$session->get('id'));
            return view('profs/v_profs');
        } else {
    ...
    public function ftrProfs(){
        ...
        $data = $model->filterProfessions($ftrdata);
